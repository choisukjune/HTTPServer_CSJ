...
var createWindow = function() {
  ...
  mainWindow = new BrowserWindow(
	 {
        ...
        icon: ROOTPATH + './__electron_root/pine-tree.ico', //[NativeImage](https://github.com/atom/electron/blob/master/docs/api/native-image.md) - The window icon, when omitted on Windows the executable's icon would be used as window icon.
  ...
  mainWindow.loadURL('file://' + ROOTPATH + '/__electron_root/index.html');

  // Open the DevTools.
  mainWindow.webContents.openDevTools();

  //HTTPServer_MongoDB - 49320 - MemberSession 서버;
  mainWindow.webContents.executeJavaScript('require( "' + ROOTPATH + '/index.js" );');
