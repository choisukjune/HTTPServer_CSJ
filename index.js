...
//ATLAS MongoDB;
global.DB__ATLAS = {};
global.DB__ATLAS.Info = { mongoPath : "mongo", MongoDBServerURL : "127.0.0.1:55555/admin", ID : "tjrwns", PASS : "q1q1q1q1q1" };
global.DB__ATLAS.CONFIG = {};
global.DB__ATLAS.CONFIG.driver_connect_url = 'mongodb://' + global.DB.Info.ID + ':' + global.DB.Info.PASS + '@127.0.0.1:55555/admin';
global.DB__ATLAS.CONFIG.console_excute_command_js = [ global.DB.Info.mongoPath, global.DB.Info.MongoDBServerURL, '-u', global.DB.Info.ID, '-p', global.DB.Info.PASS, '<' ];
global.DB__ATLAS.CONFIG.console_excute_command_eval = [ global.DB.Info.mongoPath, global.DB.Info.MongoDBServerURL, '-u', global.DB.Info.ID, '-p', global.DB.Info.PASS, '--eval' ];
