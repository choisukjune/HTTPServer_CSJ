...
//	var urls = {
//		original : "/api/session_check?sid=" + session
//		, google_oauth : "/api/google_oauth_session_check?sid=" + session
//	}

	var url = "/api/session_check?sid=" + session;
...
window.service.session.setSession = function( sid ){
	//var session_id = SHA1( SHA512( Date.now() + "_" + id ) );
	window.service.cookie.setCookie( "session", sid, 1000*60*15 )
}


window.service.session.removeSession = function( cookieName ){
 ...
 window.service.session.remove_deleteCookies =  function(){
	var count = 0; // 쿠키 개수
