global.api.DB_console.console_excute_command_eval = function( _q, _cbFunction ){
	...
	var db_excute_command = [ global.DB.Info.mongoPath, global.DB.Info.MongoDBServerURL, '-u', global.DB.Info.ID, '-p', global.DB.Info.PASS, '--eval'];

	db_excute_command.push( _q );

	var _exec = global.REQUIRES.child_process.spawnSync( db_excute_command );
